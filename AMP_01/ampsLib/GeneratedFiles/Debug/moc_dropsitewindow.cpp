...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DropSiteWindow_t, stringdata) + ofs \
...
const QMetaObject DropSiteWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DropSiteWindow.data,
      qt_meta_data_DropSiteWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DropSiteWindow.stringdata))
