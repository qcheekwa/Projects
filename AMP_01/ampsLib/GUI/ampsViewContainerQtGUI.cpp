...
ampsViewContainerQtGUI::ampsViewContainerQtGUI(const QObject *parent) : QObject((QObject *)parent)
{
  Init();
}
...
{
  m_WinProjView = new ampsWinProjView;
...
/*
  ...
  //m_FolderTreeView = new QTreeWidget;
*/ //
...
/*
  ...
  //m_FolderItemView->setDragDropMode(...);
  //m_FolderItemView->setFirstColumnSpanned();
*/
...
void ampsViewContainerQtGUI::InitDockAssetView(void)
{
  ...
  m_TabDockWinAssetView->addDockWidget(Qt::RightDockWidgetArea, m_DockWidgetAssetRevision);

  //m_TabDockWinAssetView->addDockWidget(Qt::AllDockWidgetAreas, m_DockWidgetAssetTNView);
  m_TabDockWinAssetView->addDockWidget(Qt::LeftDockWidgetArea, m_DockWidgetAssetTNView);
...
void ampsViewContainerQtGUI::InitDockFolderView(void)
{
  ...
  //m_DockWidgetFolderView->m_ScrollWidgetFolderView->m_WidgetFolderView->m_UI.m_scrollAreaTreeView->setWidget(m_FolderTreeView);//
  //m_DockWidgetFolderView->m_ScrollWidgetFolderView->m_WidgetFolderView->m_UI.m_scrollAreaItemView->setWidget(m_FolderItemView);//
}
...
*/
  ...
  m_TabDockWinProjView->addDockWidget(Qt::RightDockWidgetArea, m_DockWidgetProjChart);
