...
public:
    ...
    void setupUi(QWidget *Form_ampsWidgetProjInfo)
    {
        ...
        label_6 = new QLabel(Form_ampsWidgetProjInfo);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(470, 130, 101, 16));
        lineEdit_4 = new QLineEdit(Form_ampsWidgetProjInfo);
    ...
    void retranslateUi(QWidget *Form_ampsWidgetProjInfo)
    {
        ...
        label_6->setText(QApplication::translate("Form_ampsWidgetProjInfo", "Estimated Duration", 0));
